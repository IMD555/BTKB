...
void high_isr (void) __attribute__((address(0x08)));
void low_isr (void) __attribute__((address(0x18)));
...
void FLASH_WriteBlock2(__uint24 writeAddrStart, unsigned char size, unsigned char* flashWrBufPtr)
{
 ...
 if (lastErasedPage != (writeAddrStart&0x00ffff80UL))
 {

  FLASH_EraseBlock((writeAddrStart&0x00ffff80UL));
  lastErasedPage = (writeAddrStart&0x00ffff80UL);
 }
 ...
 TBLPTR = writeAddrStart;



 while (iii < size)
 {
  TABLAT = flashWrBufPtr[iii++];
...
void FLASH_WriteBlock(__uint24 writeAddrStart, unsigned char size, unsigned char* flashWrBufPtr)
{
 ...
 if (0x80 & ((adr2) + size - 1))
 {
  ...
  FLASH_WriteBlock2((writeAddrStart&0x00ffff80UL) + 0x80, size - size1, flashWrBufPtr + size1);
 }
 else
 {
