...
void main(void)
{
 ...
 while (1) {
  ...
  led[3] = led[4] = fnEnable | fnEnableLatch;
  led[6] = keyReport.modifierLatch.bits.AltL | keyReport.modifier.bits.AltL | keyReport.modifier2.bits.AltL;
  led[7] = keyReport.modifierLatch.bits.GuiL | keyReport.modifier.bits.GuiL | keyReport.modifier2.bits.GuiL;
  led[5] = keyReport.modifierLatch.bits.CtrlL | keyReport.modifier.bits.CtrlL | keyReport.modifier2.bits.CtrlL;
  led[8] = led[9] = keyReport.modifierLatch.bits.ShiftL | keyReport.modifierLatch.bits.ShiftR | keyReport.modifier.bits.ShiftL | keyReport.modifier.bits.ShiftR | keyReport.modifier2.bits.ShiftL | keyReport.modifier2.bits.ShiftR;
  led[0] = keyMode == 0 && BtConnected ^ RF1;
  led[1] = keyMode == 1 && BtConnected ^ RF1;
  led[2] = keyMode == 2 && BtConnected ^ RF1;
  led[10] = GetChgState();
  led[11] = (volt * 2 - 560) > sawToothWave;
